...
Levels match [AUTOMATION_LEARNING_GUIDE.md](./AUTOMATION_LEARNING_GUIDE.md). Start **after** Iteration 5. There is no `tests/` tree on purpose.

Definition of done is what _you_ produce. This repo will not ship a framework.

| Level | Name             | Definition of done                                                                   |
| ----- | ---------------- | ------------------------------------------------------------------------------------ |
| 1     | Basic Playwright | `playwright.config` exists because **you** added it. One spec: valid customer login. |
